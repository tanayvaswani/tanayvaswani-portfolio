...
export default function Navbar() {
  ...
  return (
    <header className="relative z-[999]">
      <motion.div className="fixed left-1/2 top-0 h-[4.5rem] w-full -translate-x-1/2 rounded-none border border-black border-opacity-40 bg-neutral-800 bg-opacity-80 backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.3rem] sm:w-[41.5rem] sm:rounded-full"></motion.div>
