...
export const experienceContent = [
  {
    ...
    description: [
      "The planning, design, and execution of website development projects to ensure they deliver exceptional user experiences. This involves coordinating with team members to prioritise features, optimise performance, and maintain consistency across the site.",
      ...
      "Employing a range of libraries and frameworks to enhance different aspects of website functionality, including form handling, data processing, animation effects, scrolling behaviour, and UI design",
